...
openmdao.DataflowFigure.prototype.createHTMLElement=function(){
    ...
    if (this.pathname !== '') {
        ...
        this.top_left.style.className="DataflowFigureTopLeft";
        ...
        this.bottom_left.style.className="DataflowFigureBottomLeft";
        ...
        this.bottom_right.style.className="DataflowFigureBottomRight";
        ...
        this.footer.style.className="DataflowFiugreFooter";
        ...
        this.contentArea.style.className="DataflowFigureContentArea";
